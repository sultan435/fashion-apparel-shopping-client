...
const HmUpdate = () => {
    const hmProduct = useLoaderData()
    const { _id, name, image, description, type, price, brandName, rating } = hmProduct;

    const handleUpdateHm = event => {
        ...
        <div>
            <div className="bg-[#f2f2f2]">
                ...
                <div className=' py-16 px-4 lg:px-28 max-w-screen-xl mx-auto '>
                    <h1 className='text-5xl text-[#374151] mb-8 text-center'>Update H&M Product</h1>
                    <form onSubmit={handleUpdateHm} className='mt-10'>
