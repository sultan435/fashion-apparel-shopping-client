...
const GucciDetails = () => {
    ...
    const handleDataStore = (name, type, image, brandName) => {

        const singleProducts = { name, type, image, brandName };
                        ...
                        <div className="px-4">
                            ...
                            <div className="mt-8 ">
                                ...
                                <div className="mt-4 flex gap-4 items-center">
                                    <button onClick={() => handleDataStore(name, type, image, brandName)} className="py-2 rounded-lg w-full border-2 border-slate-900 bg-slate-900  text-white font-semibold">Add To Bag</button>
